...
<xsl:with-param name="title"><xsl:copy-of select="/cp/strings/cp_title" /> : <xsl:copy-of select="/cp/strings/bc_user_list" /> : <xsl:copy-of select="/cp/strings/bc_user_edit_profile"/> <xsl:copy-of select="$loginid" /> </xsl:with-param>
