...
XS_EUPXS(XS_VSAP__Server__G11N__Date_localtime); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_VSAP__Server__G11N__Date_localtime)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "when");
    {
	time_t	when = (time_t)SvNV(ST(0))
;
	SV *	RETVAL;
#line 19 "Date.xs"
        time_t mytime    = when;
...
extern "C"
#endif
XS_EXTERNAL(boot_VSAP__Server__G11N__Date); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_VSAP__Server__G11N__Date)
{
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK;
        ...
        (void)newXSproto_portable("VSAP::Server::G11N::Date::localtime", XS_VSAP__Server__G11N__Date_localtime, file, "$");
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
