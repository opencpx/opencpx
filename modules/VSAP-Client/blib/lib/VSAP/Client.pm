...
our $CVS_VERSION = '$SMEId: apps/vsap/VSAP-Client/lib/VSAP/Client.pm,v 1.34 2012/12/17 19:08:35 rus Exp $';
...
sub quit {
    my $client = shift;
    $client->send("<vsap><vsap type='logout'\/></vsap>")
        || return undef; 
    if (${*$client}{ssl}) {
...
sub parse_response {
	...
	## leave the evil spirits alone (HIC-409).  -scottw
#        # remove evil spirits
#        $str = $client->valid_utf8($str);
